...
(book / article / youtube), each with a title, url, claim, and citation.
...
_SYSTEM = (
    ...
    '  "kind": one of "book", "article", or "youtube".\n'
    '  "title": the real title of the book, article, or video.\n'
    '  "url": a plausible direct URL (publisher page, DOI, article link, or '
    "youtube watch URL). Never invent fake domains.\n"
    '  "claim": one sentence — what this source concretely says about the hypothesis.\n'
    '  "citation": author(s) + year (+ publication/channel).\n'
    "Rules:\n"
    "- Include a MIX of kinds: at least one book, one article, and one youtube.\n"
