...
_SUMMARY_DATA = {
    "paragraphs": [
        "Running performance dropped significantly, prompting investigation into overtraining as the leading explanation.",
        "The primary competing plan attributes the decline to excessive training volume without adequate recovery.",
        "A short measurement probe of resting HRV is recommended to test this hypothesis over the next week.",
    ],
    "references": [],
}
